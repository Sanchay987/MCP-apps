"""
Enterprise MCP Server with Knowledge Graph Tool

This server includes both the basic tools and the enterprise
Knowledge Graph tool (for Generative UI demonstration).
"""
...
if __name__ == "__main__":
    print("=" * 70)
    print("Enterprise KPMG MCP Server Starting")
    print("=" * 70)
    print("\nAvailable Tools:")
    print("  Day 1 (Basic):")
    ...
    print("\n" + "=" * 70)
    print("Server ready. Listening on stdio transport...")
    print("Total Tools: 12 (3 basic + 6 enterprise + 3 live Gremlin)")
    print("=" * 70 + "\n")
